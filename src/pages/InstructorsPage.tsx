  ...
  const fetchAccounts = useCallback(async () => {
    ...
    try {
      ...
      setAccounts(result.filter((a) =>
        a.status === "approved" && a.roles.includes("instructor")
      ));
    } catch {
      setAccounts([]);
    } finally {
  ...
  return (
    <>
      <div className="page-header">
        <h2>Instrutores</h2>
        <p>Instrutores ativos do projeto</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="empty-state">
          ...
          <h3>Nenhum instrutor</h3>
          <p>Membros aprovados com perfil de instrutor aparecerão aqui.</p>
        </div>
      ) : (
        <>
                  ...
                  <div className="account-card-header">
                    ...
                    <div className="account-info">
                      ...
                      <div className="account-meta">
                        <span className="account-role-chip">Instrutor</span>
                      </div>
                    </div>
                  </div>
                </div>
